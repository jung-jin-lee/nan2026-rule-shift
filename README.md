...
NAN 2026 사전 과제용 브라우저 아케이드 프로토타입입니다. 플레이어는 60초 동안 오브를 모으고 드론을 피하며, 8초마다 바뀌는 규칙과 15초마다 상승하는 스테이지 압력에 적응해야 합니다.
...
- 60초 플레이 런과 15초 단위 4스테이지(SYNC → PRESSURE → OVERLOAD → BREAKPOINT)
- 스테이지별 드론 수·속도·충돌 페널티·오브 밀도 상승/감소, 후반 점수 배율(×1.00 → ×2.00)
- 전환 배너·합성 효과음·화면 피드백과 짧은 전환 무적/드론 스폰 유예
